...
const QuizList = () => {
  ...
  useEffect(() => {
    axios
      .get('https://a4r4thtih1.execute-api.us-east-1.amazonaws.com/list_quizzes')
  ...
  const handleDeleteGame = (quizId) => {
    axios
      .delete(`https://a4r4thtih1.execute-api.us-east-1.amazonaws.com/delete_quiz/${quizId}`)
      .then((response) => {
  ...
  const handleFormSubmit = (event) => {
    ...
    axios
      .put(`https://a4r4thtih1.execute-api.us-east-1.amazonaws.com/edit_quiz/${editFormData.quizId}`, formattedFormData)
      .then((response) => {
  ...
  const handleViewQuestions = (quizId) => {
    axios
      .get(`https://a4r4thtih1.execute-api.us-east-1.amazonaws.com/get_quiz_questions/${quizId}`)
      .then((response) => {
